...
<div class="wrapper">
	<div id="top">
        ...
        <nav>	<!-- Navigation Start -->
            <ul>
            	<li><a href="jsp/zyqindex.jsp">HOME</a></li>
    ...
    <section id="workbody"><!-- Project images start -->
    	<img src="images/work/SkiesOfSpain/sky1.png" alt="sky1"><!-- Use whatever images you like - they will automatically fit the width of the page -->
